...
const uint64_t pAddress = 0xE8E8F0F0E1LL; // Radio pipe address
...
void setup()
{
  ...
  // initialize device
    ...
    analogWrite(3,0);
    Serial.println("Begin Left device");
...
void vibrationOn(){
  analogWrite(3,vibration_amplitude);
  if (vibration_amplitude < 255){
    vibration_amplitude = vibration_amplitude + 20;
    if (vibration_amplitude > 255){
      vibration_amplitude = 255;
    }
  }
